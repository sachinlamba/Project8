...
//  Project8
//
//  Created by Sachin Lamba on 25/06/16.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for subview in view.subviews where subview.tag == 1001 {
            ...
            btn.addTarget(self, action: #selector(letterTapped), forControlEvents: .TouchUpInside) // code version of Ctrl-dragging in a storyboard
        }
